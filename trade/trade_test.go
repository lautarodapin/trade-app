...
func TestMakeTrade(t *testing.T) {
	...
	t.Run("Buy 12 at 100 of FAKESYMBOL", func(t *testing.T) {
	...
	t.Run("Buy 17 at 99 of FAKESYMBOL", func(t *testing.T) {
	...
	t.Run("Buy 3 at 103 of FAKESYMBOL", func(t *testing.T) {
		trade := createBuyTrade(db, user, 103, 3, SYMBOL)
		if trade.ID == 0 {
			t.Fatal("trade not created")
		}
	})
	t.Run("Buy 3 at 103 of OTHER symbol", func(t *testing.T) {
		trade := createBuyTrade(db, user, 103, 3, "OTHER")
		if trade.ID == 0 {
			t.Fatal("trade not created")
		}
	})
